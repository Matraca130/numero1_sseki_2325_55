...
export const PROFESSOR_COLORS = {
  /** Primary button bg */
  primary: 'bg-[#2a8c7a]',
  primaryHover: 'hover:bg-[#244e47]',
  primaryDisabled: 'bg-[#2a8c7a]/60 cursor-wait',
  /** Icon/text accent */
  accent: 'text-[#2a8c7a]',
  accentMuted: 'text-[#2a8c7a]/80',
  /** Surface backgrounds */
  surfaceBold: 'bg-teal-100',
  surface: 'bg-teal-50',
  /** Focus ring for inputs */
  ring: 'focus:ring-[#2a8c7a]/20 focus:border-[#2a8c7a]',
  /** Hover states */
...
export const BTN_PRIMARY_SM =
  'flex items-center gap-1.5 px-3.5 py-2 rounded-full text-[12px] text-white transition-all shadow-sm';

/** Secondary/ghost button */
export const BTN_GHOST =
  'px-4 py-2 text-[12px] text-gray-500 hover:text-gray-700 transition-colors rounded-full hover:bg-gray-100';
