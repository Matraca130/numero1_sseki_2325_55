...
//
// NOTE: ChunkRenderer.tsx has duplicated copies of enrichHtmlWithImages,
// MD_IMAGE_RE, RAW_IMAGE_URL_RE with gray-* instead of zinc-* classes.
// Deduplication deferred — see PHASE2_ARCHITECTURE.md.
// ============================================================
 ...
 */
export function enrichHtmlWithImages(html: string): string {
 ...
 */
export function renderPlainLine(line: string, key: number): React.ReactNode {
