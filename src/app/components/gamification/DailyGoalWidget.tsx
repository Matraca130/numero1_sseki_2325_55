...
// Preset stops for the slider (nicer UX than raw 10-1000)
    ...
    >
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-zinc-400 tabular-nums" style={{ fontWeight: 600 }}>
            {sliderValue} XP
          </span>
        </div>
            ...
            <button
              ...
              className={`px-2 py-0.5 rounded-full text-[10px] border transition-all ${
                sliderValue === preset
                  ...
                  : 'bg-zinc-800/40 border-zinc-700/40 text-zinc-500 hover:text-zinc-400 hover:border-zinc-600/60'
              }`}
      ...
      {hasChanged && (
        <motion.button
          ...
          disabled={saving}
          onClick={handleSave}
          className="w-full py-2 rounded-lg text-xs text-white bg-teal-600 hover:bg-teal-500 transition-colors disabled:opacity-50 flex items-center justify-center gap-1.5"
