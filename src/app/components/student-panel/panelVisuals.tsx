...
export const COURSE_VISUALS = [
  { icon: '\u{1F9E0}', bg: 'bg-teal-100', progress: 'bg-teal-500', percent: 'text-teal-600' },
  { icon: '\u{1F33F}', bg: 'bg-[#e6f5f1]', progress: 'bg-axon-accent', percent: 'text-axon-accent' },
  { icon: '\u{1F52C}', bg: 'bg-teal-100', progress: 'bg-teal-500', percent: 'text-teal-600' },
  { icon: '\u{2764}\u{FE0F}', bg: 'bg-pink-100', progress: 'bg-pink-500', percent: 'text-pink-600' },
];

export const ACTIVITY_VISUALS = [
  { icon: <Play size={16} />, bg: 'bg-teal-100', color: 'text-teal-600', label: 'Video de Anatomia', sub: 'Sistema Cardiovascular' },
