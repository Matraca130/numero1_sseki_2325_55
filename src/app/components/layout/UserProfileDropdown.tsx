      ...
      <div className="relative">
        ...
        >
          <div className="text-right hidden md:block">
            ...
            <p className="text-[10px] text-axon-accent/70 font-medium tracking-wide uppercase">{activeRole}</p>
          </div>
          <div className="relative">
            <img
              ...
              alt="User"
              className="w-8 h-8 rounded-full object-cover ring-[1.5px] ring-white/15 group-hover:ring-axon-accent/50 transition-all"
            />
          ...
          {isOpen && (
            ...
            >
              ...
              <div className="relative px-4 pt-4 pb-3 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-axon-accent/10 via-transparent to-transparent" />
                <div className="relative flex items-center gap-3">
                  <div className="relative shrink-0">
                    <img
                      src="https://images.unsplash.com/photo-1659353887222-630895f23cc5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpY2FsJTIwZG9jdG9yJTIwbWluaW1hbGlzdGljfGVufDF8fHx8MTc2OTAzMzY1M3ww&ixlib=rb-4.1.0&q=80&w=1080"
                      alt="User"
                      className="w-10 h-10 rounded-full object-cover ring-2 ring-axon-accent/30"
                    />
                  ...
                  <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-axon-accent/20 border border-axon-accent/20 shrink-0">
                    <Zap size={9} className="text-axon-accent" />
                    <span className="text-[9px] font-semibold text-[#99d7c7] uppercase tracking-wider">{activeRole}</span>
                  </span>
                </div>
              </div>
              ...
              <div className="py-1 px-1.5 max-h-[calc(100vh-200px)] overflow-y-auto custom-scrollbar">
                ...
                <DropdownItem icon={<Award size={15} />} label="Logros" badge="Nuevo" badgeColor="emerald" />
                ...
                <DropdownItem icon={<HelpCircle size={15} />} label="Centro de Ayuda" />
...
function DropdownItem({
  ...
  const badgeBg = badgeColor === 'emerald'
    ...
    : 'bg-axon-accent/15 text-axon-accent border-axon-accent/20';
