...
//   5. ActivityChart and MasteryDonut are now memoized
// ============================================================
...
export const ActivityChart = React.memo(function ActivityChart({ data }: ActivityChartProps) {
  return (
    <motion.div
...
export const MasteryDonut = React.memo(function MasteryDonut({ data, totalCards }: MasteryDonutProps) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 10 }}
      animate={{ opacity: 1, y: 0 }}
