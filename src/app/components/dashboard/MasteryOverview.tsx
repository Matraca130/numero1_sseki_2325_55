        ...
        <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-lg border transition-colors ${
                filter !== 'all'
                  ...
                  : 'border-gray-200 bg-[#faf9f6] text-gray-500 hover:text-gray-700'
              }`}
            >
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Buscar..."
              className="w-36 sm:w-44 pl-8 pr-3 py-1.5 text-xs rounded-lg border border-gray-200 bg-[#faf9f6] text-gray-700 placeholder:text-gray-400 focus:outline-none focus:border-[#2a8c7a]/50 focus:ring-1 focus:ring-[#2a8c7a]/20 transition-colors"
            />
          </div>
        </div>
      </div>
