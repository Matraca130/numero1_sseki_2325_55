          ...
          {onAdaptiveQuizReady && questions[0]?.summary_id && (
            ...
            >
              <button
                ...
                className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full text-sm text-teal-600 bg-teal-50 border border-teal-200 hover:bg-teal-100 hover:border-teal-300 transition-all"
                style={{ fontWeight: 600 }}
              >
                <Brain size={16} />
