...
export function AiPracticeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-teal-100 bg-gradient-to-r from-teal-50 to-white">
          ...
          {!loading && !error && generatedQuestion && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex items-center gap-2 text-[12px] text-teal-600 hover:text-teal-800 transition-colors mx-auto px-4 py-2 rounded-xl hover:bg-teal-50"
              ...
              {showAnswer && (
                ...
                >
                  ...
                  {generatedExplanation && (
                    <div className="px-3 py-2.5 rounded-xl bg-teal-50 border border-teal-100">
                      <p className="text-[10px] text-teal-500 uppercase tracking-wider mb-1" style={{ fontWeight: 700 }}>
                        Explicacion
                      </p>
                      <p className="text-[12px] text-teal-700" style={{ lineHeight: '1.5' }}>
                        {generatedExplanation}
                      </p>
                    </div>
                  )}
