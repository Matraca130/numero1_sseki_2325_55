...
//
// Agent: TIMER
// Circular countdown timer with visual urgency states.
// Auto-fires onTimeout when time reaches zero.
// ============================================================
...
export const QuizCountdownTimer = React.memo(function QuizCountdownTimer({
  ...
  return (
    <motion.div
      ...
      title={`${mins}:${String(secs).padStart(2, '0')} restantes`}
    >
      ...
      <span
        className={clsx(
          'absolute text-center tabular-nums',
          compact ? 'text-[8px]' : 'text-[10px]',
          remaining === 0 ? 'text-red-500' : 'text-zinc-600',
        )}
