                  ...
                  <div className="flex flex-col gap-4">
                    <div>
                      ...
                      <textarea
                        ...
                        rows={10}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-400 transition-all resize-none font-mono text-gray-700 placeholder:text-gray-300"
                      />
                    </div>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-teal-600 text-white text-sm font-semibold hover:bg-teal-700 disabled:opacity-50 transition-all self-end"
                    >
                      Previsualizar
            ...
            <div className="shrink-0 px-6 py-4 border-t border-gray-100 flex items-center justify-between">
              ...
              {importing ? (
                ...
                <button
                  ...
                  disabled={!canImport}
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-teal-600 text-white text-sm font-semibold hover:bg-teal-700 disabled:opacity-50 transition-all shadow-sm shadow-teal-200"
                >
                  <Check size={14} />
