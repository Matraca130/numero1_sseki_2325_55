        ...
        <button
          ...
          className={clsx(
            ...
            createMutation.isPending || !name.trim()
              ...
              : 'bg-teal-600 text-white hover:bg-teal-700 shadow-sm active:scale-[0.97]'
          )}
...
function FloatingButton({ position, onClick }: FloatingButtonProps) {
  return createPortal(
    <motion.button
      ...
      onClick={onClick}
      className="fixed z-[55] flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-teal-600 text-white shadow-lg shadow-teal-600/25 text-xs hover:bg-teal-700 active:scale-95 transition-all cursor-pointer"
      style={{
        top: `${position.top}px`,
