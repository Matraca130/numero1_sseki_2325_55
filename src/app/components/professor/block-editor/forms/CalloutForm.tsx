...
const variants = [
  { value: 'tip', label: 'Tip', color: 'bg-green-100 text-green-700 border-green-300' },
  { value: 'warning', label: 'Warning', color: 'bg-amber-100 text-amber-700 border-amber-300' },
  { value: 'clinical', label: 'Clinical', color: 'bg-blue-100 text-blue-700 border-blue-300' },
  { value: 'mnemonic', label: 'Mnemonic', color: 'bg-violet-100 text-violet-700 border-violet-300' },
  { value: 'exam', label: 'Exam', color: 'bg-red-100 text-red-700 border-red-300' },
] as const;
