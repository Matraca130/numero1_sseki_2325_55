  ...
  if (stats.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-surface-dashboard p-8 text-center">
        <p className="text-gray-500">No hay datos de la sesi{'\u00F3'}n.</p>
        <button
          onClick={onExit}
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-sm text-gray-800" style={{ fontWeight: 600 }}>
                Refuerza tus puntos d{'\u00E9'}biles
              </span>
            </div>
            <p className="text-xs text-gray-500 mb-4">
              Genera flashcards personalizadas con IA enfocadas en lo que m{'\u00E1'}s necesitas practicar
            </p>
            <button
