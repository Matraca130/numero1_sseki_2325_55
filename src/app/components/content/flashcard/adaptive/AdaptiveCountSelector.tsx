...
//
// Lets the student choose how many AI flashcards to generate.
// Options: 5 / 10 / 15 with a "recommended" badge on 10.
//
// WHY 10 recommended: The backend's 2h dedup window ensures
// variety for ~5 unique keywords. Beyond 10, cards cluster on
// the weakest keyword (see RECOMMENDED_MAX_BATCH in Phase 2).
//
