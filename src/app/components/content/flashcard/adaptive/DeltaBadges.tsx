  ...
  const badgeCls = (color: string) =>
    isPill
      ? clsx('flex items-center gap-1.5 px-3 py-1.5 rounded-lg border',
          ...
          color === 'gray' && 'bg-[#faf9f6] border-gray-200')
    ...
    <div className={wrapperCls}>
      {deltaStats.improved > 0 && (
        <div className={badgeCls('emerald')}>
          ...
          <span className={clsx('text-emerald-700', isPill && 'text-xs')} style={{ fontWeight: 600, fontSize: isPill ? undefined : '0.75rem' }}>
      ...
      {deltaStats.newlyMastered > 0 && (
        <div className={badgeCls('amber')}>
          ...
          <span className={clsx('text-amber-700', isPill && 'text-xs')} style={{ fontWeight: 600, fontSize: isPill ? undefined : '0.75rem' }}>
      ...
      {deltaStats.declined > 0 && (
        <div className={badgeCls('rose')}>
          ...
          <span className={clsx('text-rose-700', isPill && 'text-xs')} style={{ fontWeight: 600, fontSize: isPill ? undefined : '0.75rem' }}>
      ...
      <div className={badgeCls('gray')}>
        ...
        <span className={clsx(isPill ? 'text-xs text-gray-600' : 'text-gray-500')} style={{ fontSize: isPill ? undefined : '0.75rem' }}>
