...
export function StudentPlaceholder({
  ...
  return (
    <div className="h-full flex items-center justify-center p-8 bg-[#faf9f6]/50">
      <motion.div
      ...
      >
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center">
          ...
          {/* Construction badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#faf9f6] border border-gray-100 mb-6">
