// ============================================================
// Axon — SectionCard (extracted from StudyHubSectionCards.tsx)
//
// Presentational card for a single TreeSection inside the Study Hub.
// Supports collapsed (cover + preview) and expanded (topics grid) states.
//
// Extracted as part of god-component split (finding #22).
// ============================================================
import React, { useState } from 'react';
import { motion, AnimatePresence, useReducedMotion } from 'motion/react';
import {
  BookOpen, ChevronLeft, ArrowRight, CheckCircle2, Clock,
} from 'lucide-react';
...
export const EMOJI = ['\u{1FAC0}','\u{1F9E0}','\u{1F52C}','\u{1F9EC}','\u{1FA7A}','\u{1F9D1}\u{200D}\u{2695}\u{FE0F}'] as const;
...
// ── TopicStatusIcon ──────────────────────────────────────────
export function TopicStatusIcon({ status }: { status: TopicStatus }) {
