...
const SUBJECTS: SubjectCard[] = [
  {
    ...
    retention: 92,
    retentionColor: 'text-teal-600',
    ringStroke: '#14b8a6',
    ringOffset: 10,
    consistency: 'Alta',
    consistencyColor: 'text-teal-600',
    nextReview: 'Em 2 dias',
    nextReviewColor: 'text-gray-700',
    progressPct: 80,
    progressColor: 'bg-teal-500',
    accentGradient: 'bg-gradient-to-r from-teal-400 to-teal-600',
    iconBg: 'bg-teal-100',
    iconColor: 'text-teal-600',
    icon: <Calculator size={18} />,
    heatmapColors: [
      'bg-teal-200', 'bg-teal-400', 'bg-teal-500', 'bg-teal-300', 'bg-teal-100',
      'bg-teal-500', 'bg-teal-500', 'bg-teal-400', 'bg-teal-200', 'bg-teal-100',
      'bg-teal-300', 'bg-teal-500', 'bg-teal-400', 'bg-teal-200', 'bg-teal-100',
      'bg-teal-500', 'bg-teal-300', 'bg-teal-400', 'bg-teal-200', 'bg-teal-50',
    ],
  },
  {
    id: '2',
  ...
  },
  {
    ...
    heatmapColors: [
      'bg-teal-100', 'bg-teal-200', 'bg-teal-200', 'bg-teal-300', 'bg-teal-300',
      'bg-teal-400', 'bg-teal-400', 'bg-teal-500', 'bg-teal-500', 'bg-teal-500',
      'bg-teal-200', 'bg-teal-300', 'bg-teal-400', 'bg-teal-400', 'bg-teal-500',
          ...
          {activeTab === 'settings' && (
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <button className="w-full sm:w-auto px-6 py-2.5 bg-teal-600 text-white text-sm rounded-lg shadow-md hover:bg-teal-700 transition-all min-h-[44px]" style={{ fontWeight: 700 }}>
