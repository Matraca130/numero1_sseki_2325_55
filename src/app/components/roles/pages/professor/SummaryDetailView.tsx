...
const TipTapEditor = lazy(() =>
  import('@/app/components/tiptap/TipTapEditor').then(m => ({ default: m.TipTapEditor }))
);
import {
...
export function SummaryDetailView({
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      {/* ═══════════════════════════════════════════════════ */}
      <Suspense fallback={<div className="flex-1 flex items-center justify-center"><Loader2 className="animate-spin text-gray-400" size={32} /></div>}>
        <TipTapEditor
