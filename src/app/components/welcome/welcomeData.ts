...
// ============================================================
import { BookOpen, Layers, GraduationCap, Box, Flame } from 'lucide-react';
...
export const SHORTCUT_CARDS: ShortcutCard[] = [
  ...
  { title: 'Atlas 3D', subtitle: 'Explorar modelos', icon: Box, color: components.shortcutCard.iconColor, bg: components.shortcutCard.iconBg, view: '3d' },
  { title: 'Mapa de Calor', subtitle: 'Tu actividad de estudio', icon: Flame, color: components.shortcutCard.iconColor, bg: components.shortcutCard.iconBg, view: 'knowledge-heatmap' },
];
