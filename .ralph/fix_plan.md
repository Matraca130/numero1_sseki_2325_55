...
- [ ] Compartir mapa entre estudiantes — generar link público de solo lectura
...
- [ ] Integrar IA tutor panel con datos REALES del backend (endpoints ya creados)
- [ ] Comparar mapa del student vs mapa "ideal" del professor
